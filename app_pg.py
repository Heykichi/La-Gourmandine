...
LOGO_PATH = r"c:\Users\victo\OneDrive\Images\Screenshots\Capture d'écran 2026-03-25 135153.png"
...
def get_connection():
    return psycopg2.connect(host="localhost", database="boulangerie_app", user="postgres", password="Marine")
